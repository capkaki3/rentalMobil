...
--
-- Host: localhost
-- Generation Time: Jul 26, 2020 at 06:06 PM
...
(1, 'kamal2', 'kamal2', 'Users'),
(7, 'yafir2', 'yafir2', 'Karyawan'),
(18, 'iang', 'iang', 'Karyawan');
...
('1', 'Fikri Kamal', '085659456882', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin'),
('2', 'yaafir', '08283753123', 'pemilik', '58399557dae3c60e23c78606771dfa3d', 'pemilik');
...
INSERT INTO `tbcostumer` (`kd_cs`, `nama_cs`, `kelamin_cs`, `alamat_cs`, `tlp_cs`, `username`, `password`, `level_cs`) VALUES
...
(3, 'kamal', 'pria', 'bogor', '08878787878', 'kamal', 'kamal', 'user');
