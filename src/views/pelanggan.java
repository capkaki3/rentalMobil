...
public String userName = "";
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(750, 704));
        setResizable(false);
        ...
        kGradientPanel1Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(kButton5, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
        ...
        mnKendaraan.setText("Pilih Kendaraan");
        ...
        mnPemilik.setText("Pemilik Kendaraan");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(kGradientPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 774, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        //String sql = "insert into tbcostumer values (?,?,?,?)";
        try {
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        ...
        try {
            String sql = "update pelanggan set nama=?,alamat=?,noTelp=? where noKtp ='" + txtid.getText() + "'  ";
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from pelanggan where noKtp ='" + txtid.getText() + "'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
