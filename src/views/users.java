...
public String userName = "";
    ...
    private void initComponents() {
        ...
        role.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Karyawan" }));
                        ...
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, kGradientPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(role, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(id))
                                .addGap(105, 105, 105))
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        try {
            ...
            stat.setString(4, role.getSelectedItem().toString());
            stat.executeUpdate();
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        ...
        try {
            String sql = "update login set username=?,password=?,role=? where id ='" + id.getText() + "'  ";
            PreparedStatement stat = conn.prepareStatement(sql);
    ...
    private void datatable() {
        ...
        try {
            String sql = "SELECT * FROM login where id like '%" + cariitem + "%' or username like '%" + cariitem + "%' order by id asc ";
