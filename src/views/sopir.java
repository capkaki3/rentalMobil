...
public class sopir extends javax.swing.JFrame {
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        try {
            ...
            stat.setString(5, tarif.getText());
            stat.setString(6, statusRe);
            stat.executeUpdate();
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        ...
        try {
            String sql = "update sopir set nama=?,alamat=?,noTelp=?,tarif=?,statusRental=? where noSim ='" + txtid.getText() + "'  ";
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from sopir where noSim ='" + txtid.getText() + "'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void datatable() {
        Object[] Baris = {"No SIM", "Nama", "Alamat", "No. Telepon","Sopir", "Status Rental"};
        tabmode = new DefaultTableModel(null, Baris);
        String cariitem = txtcari.getText();
        try {
            String sql = "SELECT * FROM sopir where noSim like '%" + cariitem + "%' or nama like '%" + cariitem + "%' order by noSim asc ";
